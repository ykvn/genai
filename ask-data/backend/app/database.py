...
# 2. Build connection URL (Clean & Python-native)
# PyMySQL natively handles the RSA key exchange via the 'cryptography' package 
# without requiring any extra URL flags.
